...
//     let minusSign = n < 0 ? -1 : 1;

//     let rev = parseInt(n.toString().split('').reverse().join('')) * minusSign;
//     if (rev < -(2 ** 31) || (2 ** 31) < rev) {
//         return 0;
//     }
//     return rev;
// }
...
// function numberToExcelColumnCode(n) {
//     let res = '';
//     while (n > 0) {
//         n--;
//         res += String.fromCharCode(65 + (n % 26));
//         n = Math.floor(n / 26)
//     }
//     return res;
// }
// console.log(numberToExcelColumnCode(25));



// function ExcelColumnCodeToNumber(s) {
//     let res = '';
//     for (let char of s) {
